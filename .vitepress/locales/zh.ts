...
export const zhConfig: LocaleSpecificConfig<DefaultTheme.Config> & { label: string; link?: string } = {
  ...
  themeConfig: {
    ...
    footer: {
      message: 'Released under the GPL-3.0 License. | <a href="/zh/docs/guide/what-is-rde">文档</a> · <a href="https://github.com/ruizi-store/rde" target="_blank">GitHub</a><br><span style="display:inline-block;margin-top:8px;">QQ 群：<img src="/qq-group-qrcode.jpg" alt="QQ群二维码" style="width:120px;height:120px;vertical-align:middle;border-radius:8px;margin-left:8px;"></span>',
