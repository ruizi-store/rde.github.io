...
hero:
  name: RDE
  text: 你的云端 Linux 桌面
  tagline: 一条命令，将任意 Linux 服务器变成功能丰富的 Web 桌面。文件管理、Docker 应用商店、终端、影音播放，全部在浏览器中完成。
  image:
    src: /rde_desktop.png
    alt: RDE 桌面预览
  actions:
...
<div class="rde-section" style="padding-top: 0;">
  <div class="install-block">
    ...
    <div id="tab-server" class="install-tab-content active">
      <div class="label">Ubuntu / Debian 快速安装（国内加速）</div>
      <div class="command">
    ...
    <div id="tab-nas" class="install-tab-content">
      <div class="label">下载 ISO 镜像，写入 U 盘启动安装，将任意 x86 主机变成 NAS</div>
      <div style="display: flex; align-items: center; gap: 1rem; padding: 1rem 1.2rem; background: rgba(0,0,0,0.3); border-radius: 10px; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="flex: 1;">
          <div style="color: #e0e7ff; font-weight: 600; font-size: 0.95rem;">RDE OS 镜像</div>
          <div style="color: #a5b4fc; font-size: 0.8rem; margin-top: 0.2rem;">基于 Debian 13，预装 RDE 桌面 + 完整依赖</div>
        </div>
...
<div class="rde-section" style="padding-top: 0;">
  <h2 class="rde-section-title">为什么选择 RDE？</h2>
  <p class="rde-section-subtitle">不只是面板，是真正的云端桌面操作系统</p>

  <!-- 桌面体验 -->
  <div class="feature-row">
    <div class="feature-content">
      <h3 class="feature-title">原生桌面级体验</h3>
      <p class="feature-desc">告别传统面板的表单操作。RDE 提供类 Windows 的完整桌面环境，让 Linux 管理变得直觉化。</p>
      <ul class="feature-points">
        <li><span class="point-icon">✦</span> 窗口拖拽、缩放、最大化、多窗口并排</li>
        <li><span class="point-icon">✦</span> 任务栏、右键菜单、桌面快捷方式</li>
        <li><span class="point-icon">✦</span> 响应式设计，手机 / 平板 / 桌面全适配</li>
      </ul>
    </div>
    <div class="feature-visual">
      <img src="/rde_desktop.png" alt="RDE 桌面环境" />
    </div>
  </div>
  ...
  <div class="feature-row reverse">
    <div class="feature-content">
      <h3 class="feature-title">强大的文件管理</h3>
      <p class="feature-desc">媲美本地文件管理器的 Web 体验，大文件传输也毫不费力。</p>
      <ul class="feature-points">
        <li><span class="point-icon">✦</span> 拖拽上传、批量操作、在线预览</li>
        <li><span class="point-icon">✦</span> TUS 协议断点续传，支持 GB 级文件</li>
        <li><span class="point-icon">✦</span> 文件分享、压缩解压、权限管理</li>
      </ul>
    </div>
    <div class="feature-visual">
      <img src="/rde_files.png" alt="RDE 文件管理" />
    </div>
  </div>
  ...
  <div class="feature-row">
    <div class="feature-content">
      <h3 class="feature-title">Docker 应用，一键部署</h3>
      <p class="feature-desc">内置应用商店，不懂 Docker 命令也能轻松部署各种服务。</p>
      <ul class="feature-points">
        <li><span class="point-icon">✦</span> 可视化容器、镜像、网络管理</li>
        <li><span class="point-icon">✦</span> 预置常用应用模板，点击即用</li>
        <li><span class="point-icon">✦</span> 实时日志、资源监控、自动更新</li>
      </ul>
    </div>
    <div class="feature-visual">
      <img src="/rde_docker.png" alt="Docker 应用商店" />
    </div>
  </div>
</div>
...
<div class="rde-section" style="padding-top: 0;">
  <h2 class="rde-section-title">开箱即用的应用生态</h2>
  <p class="rde-section-subtitle">一个平台，满足全部需求</p>
  ...
  <div class="feature-grid">
    <div class="feature-card">
      ...
      <h3>Web 终端</h3>
      <p>浏览器内完整 Linux 终端，多会话管理，主题自定义。</p>
    </div>
    <div class="feature-card">
      <div class="card-icon">
      ...
      <h3>下载管理</h3>
      <p>Aria2 驱动，HTTP / BT / 磁力全协议支持，实时进度推送。</p>
    </div>
    <div class="feature-card">
      <div class="card-icon">
    ...
    <div class="feature-card">
      ...
      <h3>视频播放器</h3>
      <p>多格式播放，ffmpeg HLS 实时转码，字幕支持，画中画模式。</p>
    </div>
    <div class="feature-card">
      <div class="card-icon">
      ...
      <h3>复古游戏</h3>
      <p>WebAssembly 模拟器，NES / SNES / GBA / PS1 经典重温。</p>
    </div>
    <div class="feature-card">
      <div class="card-icon">
      ...
      <h3>Flatpak 应用</h3>
      <p>浏览器中运行 Linux GUI 应用，跨发行版通用部署。</p>
    </div>
    <div class="feature-card">
      <div class="card-icon">
      ...
      <h3>插件系统</h3>
      <p>Unix Socket 通信，热插拔加载，按需扩展高级功能。</p>
    </div>
    <div class="feature-card">
      <div class="card-icon">
      ...
      <h3>国际化</h3>
      <p>中英双语，一键切换国内镜像源（APT / Docker / NPM / PIP）。</p>
    </div>
  </div>
</div>
...
<div class="rde-section" style="padding-top: 0;">
  <h2 class="rde-section-title">RDE vs 同类产品</h2>
  <p class="rde-section-subtitle">真正的桌面体验，而不只是 Web 面板</p>
  ...
  <div style="overflow-x: auto;">
    <table class="compare-table">
      ...
      <tbody>
        <tr>
          <td>桌面级 UI</td>
          <td class="highlight"><span class="check">✓ 完整桌面</span></td>
          <td><span class="check">✓ 完整桌面</span></td>
          <td><span class="check">✓ 完整桌面</span></td>
          <td><span class="partial">△ 简易</span></td>
          <td><span class="cross">✗ 面板</span></td>
          <td><span class="cross">✗ 面板</span></td>
        </tr>
        <tr>
          <td>文件管理器</td>
          <td class="highlight"><span class="check">✓ 桌面级</span></td>
          <td><span class="check">✓ 桌面级</span></td>
          <td><span class="check">✓</span></td>
          <td><span class="check">✓</span></td>
          <td><span class="partial">△ 基础</span></td>
          <td><span class="partial">△ 基础</span></td>
        </tr>
        <tr>
          <td>Docker 可视化</td>
        ...
        <tr>
          <td>影音播放</td>
          <td class="highlight"><span class="check">✓ 音乐+视频</span></td>
          <td><span class="partial">△ 需装套件</span></td>
          <td><span class="partial">△ 需装套件</span></td>
        ...
        <tr>
          <td>云服务器安装</td>
          <td class="highlight"><span class="check">✓ deb 一键装</span></td>
          <td><span class="cross">✗</span></td>
          <td><span class="cross">✗</span></td>
          <td><span class="check">✓</span></td>
          <td><span class="check">✓</span></td>
        ...
        <tr>
          <td>x86 裸机安装</td>
          <td class="highlight"><span class="check">✓ ISO 镜像</span></td>
          <td><span class="cross">✗ 绑硬件</span></td>
          <td><span class="check">✓</span></td>
          <td><span class="partial">△</span></td>
          <td><span class="cross">✗</span></td>
          <td><span class="cross">✗</span></td>
        ...
        <tr>
          <td>硬件绑定</td>
          <td class="highlight"><span class="check">✓ 任意 x86</span></td>
          <td><span class="cross">✗ 仅群晖硬件</span></td>
          <td><span class="check">✓ 任意 x86</span></td>
          <td><span class="check">✓ 任意</span></td>
          <td><span class="check">✓ 任意</span></td>
          <td><span class="check">✓ 任意</span></td>
        </tr>
        <tr>
          <td>价格</td>
          <td class="highlight"><span class="check">免费开源</span></td>
          <td><span class="cross">¥2000+ 硬件</span></td>
          <td><span class="check">免费</span></td>
          <td><span class="check">免费开源</span></td>
          <td><span class="partial">部分免费</span></td>
          <td><span class="check">免费开源</span></td>
        </tr>
        <tr>
          <td>开源协议</td>
          <td class="highlight"><span class="check">GPL-3.0</span></td>
          <td><span class="cross">✗ 闭源</span></td>
          <td><span class="cross">✗ 闭源</span></td>
...
<div class="rde-section">
  <h2 class="rde-section-title">谁在使用 RDE？</h2>
  <p class="rde-section-subtitle">不同场景，同样好用</p>

  <div class="persona-grid">
    <div class="persona-card">
      <div class="persona-icon">🏠</div>
      <h3>NAS / HomeLab 玩家</h3>
      <p>将闲置服务器变成私有云，管理文件、跑 Docker 服务、看电影听音乐。不用折腾命令行，全程图形化操作。</p>
    </div>
    <div class="persona-card">
      <div class="persona-icon">👨‍💻</div>
      <h3>远程开发者</h3>
      <p>随时随地通过浏览器访问开发环境。Web 终端 + 文件管理 + Docker，一台服务器搞定所有开发工具。</p>
    </div>
    <div class="persona-card">
      <div class="persona-icon">🏢</div>
      <h3>小团队运维</h3>
      <p>多用户管理，权限隔离。给团队成员分配独立桌面环境，集中管理服务器资源，降低运维门槛。</p>
    </div>
  </div>
</div>
...
<div class="rde-section" style="padding-top: 0;">
  <h2 class="rde-section-title">技术栈</h2>
  <p class="rde-section-subtitle">现代技术，可靠架构</p>
...
<div class="cta-bottom">
  <h2>准备好了吗？</h2>
  <p>一分钟部署，立即体验你的云端桌面</p>
  <div class="cta-buttons">
    <a href="/zh/docs/guide/getting-started" class="cta-btn primary">快速开始 →</a>
